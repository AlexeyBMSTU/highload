...
### Размер хранилища одного профиля 

| Сущность  | Размер в одну единицу | Допущение на одного пользователя | Итоговый размер |
| :-------- | :-------------------: | :------------------------------: | :-------------: |
| Резюме    |        200 КБ         |                3                 |     600 КБ      |
| Диалог    |         5 КБ          |                10                |      50 КБ      |
| Избранное |         1 КБ          |                5                 |      5 КБ       |
| Отклик    |         10 КБ         |                20                |     200 КБ      |
| Прочее    |         10 КБ         |                                  |      10 КБ      |

Средний размер одного профиля с учетом допущений ~ 1 MB

### Общий размер хранилища

| Сущность | Размер в одну единицу | Количество | Итоговый размер |
| :------- | :-------------------: | :--------: | :-------------: |
| Профиль  |         1 МБ          |    420М    |     400 TБ      |
| Вакансия |         50 КБ         |    8.8В    |     409 ПБ      |
| Компания |        500 КБ         |    11К     |     5.24 ГБ     |

### Сетевой трафик

| Действие                           | Суточный трафик | Среднее потребление | Пиковое потребление | RPS      |
| ---------------------------------- | --------------- | ------------------- | ------------------- | -------- |
| Просмотр вакансии                  | 237 ГБ          | 2,8 МБ/с            | 5,6 МБ/с            | 291,66 K |
| Добавление в избранное             | 1.95 ТБ         | 23.7 МБ/с           | 47.47 МБ/с          | 24,305 К |
| Просмотр откликов от работодателей | 78.23 ТБ        | 0.9 ГБ/с            | 1.8 ГБ/с            | 97,222 К |


#### Расчеты
**Просмотр вакансии** 
- Среднее время просмотра вакансии ~ 1 мин
1. 420М × 1 мин / 86400 сек × 50 КБ / мин = 237 ГБ / день
2. 237 ГБ / (24 × 3600) = 2.8 МБ/с
3. Пик: 2.8 МБ/с × 2 = 5,6 МБ/с
4. RPS: 420М × 1 мин × 60 / 86400 = 291,666 К

**Добавление в избранное** 
1. 420М × 5 × 1 КБ = 1.95 ТБ
2. 1.95 ТБ / (24 × 3600) = 23.7 МБ/с
3. Пик: 23.7 МБ/с × 2 = 47.47 МБ/с
4. RPS: 420М × 5 / 86400 = 24,305 К

Просмотр откликов от работодателей 
1. (20 × 420М) × 10 КБ = 78.23 ТБ
2. 78.23 ТБ / (24 × 3600) = 0.9 ГБ/с
3. Пик: 0.9 ГБ/с × 2 = 1.8 ГБ/с
4. RPS: (20 × 420М) / 86400 = 97,222 К
